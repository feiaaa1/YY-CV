...
export const SKILLS_PAGE_TITLE = 'AI作品集 / AI SKILLS';
/** Heading of the detail page: the folder's own name, like the projects page. */
export const SKILLS_PAGE_HEADING = 'AI作品集';
export const SKILLS_PAGE_EYEBROW = '04 / AI SKILLS';
...
export function buildSkillsWorkbenchMarkup(): string {
  return `
    <div class="skills-page" data-skills-page data-motion-ready="false" role="dialog" aria-modal="true" aria-labelledby="skills-page-heading">
      <h2 class="skills-page__sr-title" id="skills-page-heading">${escapeHtml(SKILLS_PAGE_TITLE)} · 共 ${skillPanels.length} 个项目</h2>
      <button class="skills-page__close" type="button" data-skills-close aria-label="关闭 AI作品集 并返回作品目录">
        <span aria-hidden="true">←</span><span>返回作品目录</span>
      </button>
      <div class="skills-page__viewport">
        <header class="skills-page__header">
          <p class="skills-page__kicker">${escapeHtml(SKILLS_PAGE_EYEBROW)}</p>
